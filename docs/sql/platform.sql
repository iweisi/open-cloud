...
INSERT INTO `system_api` VALUES ('530807951925968896', 'grantAccess', '获取已授权访问分页列表', 'default', '获取已授权访问分页列表', 'opencloud-base-producer', '/grant/access', '0', '1', '2019-01-04 18:01:17', '2019-01-08 16:15:58', '1');
...
INSERT INTO `system_grant_access` VALUES ('2', 'system/grant-access/index', 'ROLE_all', 'ROLE_', '1', '2', '1', 'MENU', '{\"createTime\":1532870413000,\"icon\":\"\",\"menuCode\":\"SystemGrantAccess\",\"menuDesc\":\"权限分配,菜单资源、操作资源、接口资源列表\",\"menuId\":2,\"menuName\":\"访问权限\",\"parentId\":1,\"path\":\"system/grant-access/index\",\"prefix\":\"/\",\"priority\":0,\"status\":1,\"target\":\"_self\",\"updateTime\":1546435827000}', '1', 'opencloud-base-producer');
...
INSERT INTO `system_menu` VALUES ('2', '1', 'SystemGrantAccess', '访问权限', '权限分配,菜单资源、操作资源、接口资源列表', '/', 'system/grant-access/index', '', '_self', '0', '1', '2018-07-29 21:20:13', '2019-01-02 21:30:27', '1');

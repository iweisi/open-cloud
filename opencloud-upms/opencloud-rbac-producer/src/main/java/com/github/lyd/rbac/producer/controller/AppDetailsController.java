...
import com.github.lyd.rbac.client.api.AppDetailsRemoteService;
...
@Api(tags = "应用管理")
@RestController
public class AppDetailsController implements AppDetailsRemoteService {
    @Autowired
    private AppDetailsService appInfoService;
    ...
    @PostMapping("/apps")
    @Override
    public ResultBody<PageList<AppDetailsDto>> apps(
            @RequestParam(value = "page", required = false, defaultValue = "1") Integer page,
            @RequestParam(value = "limit", required = false, defaultValue = "10") Integer limit,
            @RequestParam(name = "keyword", required = false) String keyword
    ) {
        PageList<AppDetailsDto> pageList = appInfoService.findListPage(new PageParams(page, limit), keyword);
    ...
    @Override
    public ResultBody<AppDetailsDto> getApp(
            @PathVariable("appId") String appId
    ) {
        AppDetailsDto appInfo = appInfoService.getAppInfo(appId);

...
import com.github.lyd.rbac.producer.mapper.AppInfoMapper;
...
public class AppInfoServiceImpl implements AppInfoService {
     ...
     */
    @Override
    public PageList<AppInfoDto> findListPage(PageParams pageParams,String keyword) {
        PageHelper.startPage(pageParams.getPage(),pageParams.getLimit(),pageParams.getOrderBy());
        List<AppInfoDto> list = appInfoMapper.selectAppInfo(null);
     ...
     */
    @Override
    public AppInfoDto getAppInfo(String appId) {
     ...
     */
    @Override
    public AppInfoDto getAppWithClientInfo(String appId) {
        AppInfoDto appInfo = getAppInfo(appId);
        if (appInfo == null) {
            return null;
        }
        try {

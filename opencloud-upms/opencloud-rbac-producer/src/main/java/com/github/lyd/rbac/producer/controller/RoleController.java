...
import com.github.lyd.rbac.client.api.RoleRemoteService;
...
public class RoleController implements RoleRemoteService {
    ...
    @PostMapping("/roles")
    @Override
    public ResultBody<PageList<Role>> roles(
    ...
    @Override
    public ResultBody<Role> getRole(@PathVariable(value = "roleId") Long roleId) {

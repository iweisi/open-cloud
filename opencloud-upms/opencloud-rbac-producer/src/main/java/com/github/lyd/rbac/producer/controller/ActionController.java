...
import com.github.lyd.rbac.client.api.ActionRemoteService;
...
@Api(tags = "动作资源")
@RestController
public class ActionController implements ActionRemoteService {
    @Autowired
    ...
    @PostMapping("/actions")
    @Override
    public ResultBody<PageList<ResourceAction>> actions(
    ...
    @Override
    public ResultBody<ResourceAction> getAction(@PathVariable("actionId") Long actionId) {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "description", required = false, value = "描述", paramType = "form"),
    })

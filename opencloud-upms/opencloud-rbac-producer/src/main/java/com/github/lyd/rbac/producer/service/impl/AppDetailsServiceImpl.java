...
import com.github.lyd.rbac.producer.mapper.AppDetailsMapper;
import com.github.lyd.rbac.producer.service.AppDetailsService;
import com.github.lyd.rbac.producer.service.feign.ClientDetailsRemoteServiceClient;
...
public class AppDetailsServiceImpl implements AppDetailsService {
    ...
    @Autowired
    private AppDetailsMapper appInfoMapper;
     ...
     */
    @Override
    public PageList<AppDetailsDto> findListPage(PageParams pageParams, String keyword) {
        PageHelper.startPage(pageParams.getPage(),pageParams.getLimit(),pageParams.getOrderBy());
        List<AppDetailsDto> list = appInfoMapper.selectAppInfo(null);
     ...
     */
    @Override
    public AppDetailsDto getAppInfo(String appId) {
        return appInfoMapper.getAppInfo(appId);
    }
     ...
     */
    @Override
    public AppDetailsDto getAppWithClientInfo(String appId) {

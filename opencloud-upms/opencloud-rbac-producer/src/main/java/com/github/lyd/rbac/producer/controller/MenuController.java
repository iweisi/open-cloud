...
import com.github.lyd.rbac.client.api.MenuRemoteService;
...
public class MenuController implements MenuRemoteService {
    ...
    @PostMapping("/menus")
    @Override
    public ResultBody<PageList<ResourceMenu>> menus(
    ...
    @Override
    public ResultBody<PageList<ResourceMenu>> menusAll(String keyword) {
    ...
    @Override
    public ResultBody<ResourceMenu> getMenu(@PathVariable("menuId") Long menuId) {

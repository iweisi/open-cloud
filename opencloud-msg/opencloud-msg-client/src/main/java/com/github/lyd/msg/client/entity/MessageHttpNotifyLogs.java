package com.github.lyd.msg.client.entity;
 ...
 * @author liuyadu
 */
@Table(name = "message_http_notify_logs")
public class MessageHttpNotifyLogs implements Serializable {
    @Id
    @Column(name = "msg_id")
